...
class Sequential:
    ...
    def __init__(
        self, environment_builder, max_episode_steps, workers, env_params=None
    ):
        ...
        if env_params is not None:
            [x.merge_args(env_params) for x in self.environments]
...
class Parallel:
    ...
    def initialize(self, seed):
        ...
        dummy_environment.merge_args(self.env_params)
...
def distribute(
    environment_builder, worker_groups=1, workers_per_group=1, env_params=None
):
