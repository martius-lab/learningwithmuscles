...
from .abstract_muscle_model import MuscleModelLeg
from .monoped_torque import MonopedTorque


class MuscleBiped(MuscleModelLeg):
    def __init__(self, *args, **kwargs):
        self.nq = 14
        self.model_type = "muscle_biped"
    ...
    def head_pos(self):
        return self.data.get_geom_xpos("hat_skull")
